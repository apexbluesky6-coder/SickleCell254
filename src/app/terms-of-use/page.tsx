...
export const metadata: Metadata = {
  title: "Terms of Use - Center for Sickle Cell Warriors",
  description: "Terms and conditions for using the Center for Sickle Cell Warriors website.",
};
    ...
    <div className="bg-white min-h-screen py-24 pb-32">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <div className="prose prose-lg max-w-none text-gray-dark prose-headings:font-heading prose-headings:text-foreground prose-a:text-primary">
          ...
          <p>
            By accessing and using the Center for Sickle Cell Warriors (Center for Sickle Cell Warriors) website (the "Site"), you agree to be bound by these Terms of Use and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this site.
          </p>

          <h2>2. Intellectual Property</h2>
          <p>
            The content on this website, including but not limited to text, graphics, logos, images, audio clips, digital downloads, and data compilations, is the property of Center for Sickle Cell Warriors or its content suppliers and is protected by international copyright laws.
          </p>

          <h2>3. Use License</h2>
          <p>
            Permission is granted to temporarily download one copy of the materials (information or software) on the Center for Sickle Cell Warriors website for personal, non-commercial transitory viewing only. You may not:
          </p>
          <ul>
