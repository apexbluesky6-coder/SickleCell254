          ...
          <div className="flex flex-col-reverse lg:flex-row gap-12 lg:gap-24 items-center">
            ...
            >
              ...
              <ul className="space-y-4 list-disc list-inside text-gray-dark text-lg leading-relaxed">
                <li><strong className="text-foreground">County government department of health</strong> has made available SCD essential medicines in tertiary hospitals (through Center for Sickle Cell Warriors advocacy)</li>
      ...
      <section className="py-20 lg:py-28 container mx-auto px-4 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          ...
          <p className="text-lg text-gray-dark leading-relaxed max-w-3xl mx-auto mb-12">
            Center for Sickle Cell Warriors forms strong relationships and agreements within and across communities of interest to ensure continued political will for health finance and policy.
          </p>
        </motion.div>
